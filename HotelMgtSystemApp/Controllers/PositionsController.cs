    ...
    public class PositionsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Positions != null ? 
                          ...
                          Problem("Entity set 'ApplicationDbContext.Positions'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,PositionId,Description")] Position position)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,PositionId,Description")] Position position)
        {
            if (id != position.Id)
            {
                return NotFound();
