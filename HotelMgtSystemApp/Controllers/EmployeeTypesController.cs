...
namespace HotelMgtSystemApp.Controllers
{
    ...
    public class EmployeeTypesController : Controller
    {
        ...
        {
              return _context.EmployeeTypes != null ? 
                          View(await _context.EmployeeTypes.ToListAsync()) :
                          Problem("Entity set 'ApplicationDbContext.EmployeeTypes'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description")] EmployeeType employeeType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description")] EmployeeType employeeType)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ApplicationDbContext.EmployeeTypes'  is null.");
            }
            var employeeType = await _context.EmployeeTypes.FindAsync(id);
            if (employeeType != null)
            {
