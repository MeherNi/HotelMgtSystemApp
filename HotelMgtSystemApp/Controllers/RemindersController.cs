...
namespace HotelMgtSystemApp.Controllers
{
    public class RemindersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,BookingId,ReminderType,ReminderDetail,RemindDate,Status")] Reminder reminder)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,BookingId,ReminderType,ReminderDetail,RemindDate,Status")] Reminder reminder)
        {
            if (id != reminder.Id)
            {
                return NotFound();
