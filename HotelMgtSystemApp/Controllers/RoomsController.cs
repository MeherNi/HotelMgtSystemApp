...
namespace HotelMgtSystemApp.Controllers
{
    ...
    public class RoomsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,RoomTypeId,Status,PackageId")] Room room)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,RoomTypeId,Status,PackageId")] Room room)
        {
            if (id != room.Id)
            {
                return NotFound();
