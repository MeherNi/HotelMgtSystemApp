...
namespace HotelMgtSystemApp.Controllers
{
    public class PaymentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Date,Amount,BookingId,Method,Note,PaymentDate,PaymentType,PaymentDetail,Status")] Payment payment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Date,Amount,BookingId,Method,Note,PaymentDate,PaymentType,PaymentDetail,Status")] Payment payment)
        {
            if (id != payment.Id)
            {
                return NotFound();
