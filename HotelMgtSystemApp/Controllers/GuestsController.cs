    ...
    public class GuestsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Guests != null ? 
                          ...
                          Problem("Entity set 'ApplicationDbContext.Guests'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,UserId,FirstName,LastName,ContactNumber,EmailAddress,AddressId,IdProof,CreditCard,Note")] Guest guest)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserId,FirstName,LastName,ContactNumber,EmailAddress,AddressId,IdProof,CreditCard,Note")] Guest guest)
        {
            if (id != guest.Id)
            {
                return NotFound();
